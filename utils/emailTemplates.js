...
exports.getKycApprovedEmailTemplate = async (emailObject) => {
  return `<!DOCTYPE html
  PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
    ...
    <tr>
      <td style="padding: 0">
        <table width="100%" style="border-spacing: 0;" role="presentation">
          ...
          <tr>
            <td style="text-align: center; padding: 0">
              <img src="https://fynzon-prod-public-files.s3.ap-south-1.amazonaws.com/image-03-06-2025-111-kyc_approvedpng" alt="KYCapprove_img" title="KYCapprove_img" width="160" height="100" />
            </td>
          </tr>
          ...
          <tr>
            <td>
              <p style="margin: 10px 20px;">
                Congratulations! Your KYC is verified, and your Pezon India account is now fully active.
              </p>
              <p style="margin: 10px 20px;">Start transacting today!</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align: center;">
              <button type="submit" style="
                        ...
                        border: unset;
                      ">
                <a href="${emailObject.loginUrl}" target="__blank"
                  style="color: white; text-decoration: none !important">Login</a>
              </button>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <p style="margin: 10px 20px;">Need help? Reach us at <a style="color:#0068FF; ">support@pezon.in</a></p>
...
exports.getIndividualKycPendingEmailTemplate = async (emailObject) => {
  return `<!DOCTYPE html
  PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      ...
      <td style="padding: 0">
        <table width="100%" style="border-spacing: 0;" role="presentation">
          <tr>
            <td>
              <p style="
                ...
                color: #1E1E1E !important;
              ">
                Complete Your KYC – Individual Remaining
              </p>
            </td>
          </tr>
          <tr>
            <td style="text-align: center; padding: 0">
              <img src="https://fynzon-prod-public-files.s3.ap-south-1.amazonaws.com/image-03-06-2025-695-kyc_pending_individualpng" alt="IndividualKYC_img" title="IndividualKYC_img" width="160" height="100" />
            </td>
          </tr>
          ...
          <tr>
            <td>
              <p style="margin: 10px 20px;">
                Your KYC is still pending for Individual – Aadhar, PAN, Bank and Selfie. Complete it now to avoid service interruptions:
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align: center;">
              <button type="submit" style="
                      ...
                      ">
                <a href="${emailObject.kycUrl}" target="__blank"
                  style="color: white; text-decoration: none !important">Upload Now</a>
              </button>
            </td>
          </tr>
          ...
          <tr>
            <td>
              <p style="margin: 10px 20px;">Need assistance? Contact us at <a style="color:#0068FF; ">support@pezon.in</a></p>
...
exports.getEntityKycPendingEmailTemplate = async (emailObject) => {
  return `<!DOCTYPE html
  PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      ...
      <td style="padding: 0">
        <table width="100%" style="border-spacing: 0;" role="presentation">
          <tr>
            <td>
              <p style="
                ...
                color: #1E1E1E !important;
              ">
                Complete Your KYC – Business Remaining 
              </p>
            </td>
          </tr>
          <tr>
            <td style="text-align: center; padding: 0">
              <img src="https://fynzon-prod-public-files.s3.ap-south-1.amazonaws.com/image-03-06-2025-223-kyc_pending_businesspng" alt="BusinessKYC_img" title="BusinessKYC_img" width="160" height="100" />
            </td>
          </tr>
          ...
          <tr>
            <td>
              <p style="margin: 10px 20px;">
                Your KYC is still pending for Business – GSTIN, PAN and Bank. Complete it now to avoid service interruptions:
              </p>
            </td>
          </tr>
